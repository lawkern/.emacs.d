...
(deftheme glacier "A blue GBA theme.")

;; (setq-default glacier-intensity 'hard)
(setq-default glacier-intensity 'soft)
;; (setq glacier-intensity 'hard)
;; (setq glacier-intensity 'soft)

(let ((blue+ "#b3edff")
      (blue  "#6ee2ff")
      (blue- (if (eq glacier-intensity 'soft) "#5cbad6" "#478fa4"))

      (ice+  (if (eq glacier-intensity 'soft) "#c3d7ee" "#88b0dd"))
      (ice   (if (eq glacier-intensity 'soft) "#88b0dd" "#5980a6"))
      (ice-  (if (eq glacier-intensity 'soft) "#7a98b8" "#4d6d8f"))
      (ice-- "#3e5974")

      (shadow+ (if (eq glacier-intensity 'soft) "#466686" "#233343"))
      (shadow  (if (eq glacier-intensity 'soft) "#3d5876" "#192430"))
      (shadow- (if (eq glacier-intensity 'soft) "#2b3f54" "#101822"))
  ...
  (custom-theme-set-variables
   ...
   `(evil-insert-state-cursor   '((bar . 2) ,blue))
